...
| 今回追加（Honda N-BOX / 後発対策） | 34 | 現行17タイプ×FF・4WD（N-BOX／ファッションスタイル／N-BOX JOY／CUSTOM／各特別仕様・ターボ）を登録。価格176万8,800円〜282万400円、Honda SENSINGの渋滞追従ACC・LKAS、Level 2相当・ステアリング保持必須。公式取扱説明書の「発売年月2026年07月～」を34単位へ反映、個別注文可否は未確認 |
...
| Mitsubishi | OUTLANDER PHEV 9単位、eKクロス 8単位、eKクロス EV 3単位、デリカミニ 12単位、eKスペース 4単位 | 掲載（36単位） | 1・2相当 | 2026-09-12 |
...
確認日: 2026-09-12。根拠URLと確認日はデータ正本に保持し、通常一覧には表示しない。eKスペースとデリカミニは今回掲載済み。エクリプス クロスなど三菱の残候補は、同じMI-PILOT標準／オプションと価格の突合が終わるまで未掲載候補に残す。

## 2026-09-12 Mitsubishi 購入予約導線の確認

三菱自動車の日本向け商品ページを再確認し、eKクロス、eKクロス EV、デリカミニ、eKスペースの各ページに「商談予約・購入予約受付中」が表示されることを確認した。商品掲載やオンライン見積りだけでは受注可能とせず、購入予約ページへ遷移できる明示的な一次導線がある27販売単位だけを更新した。

| 車種 | 更新単位 | 一次確認 |
|---|---:|---|
| eKクロス | 8 | [商品ページ](https://www.mitsubishi-motors.co.jp/lineup/ek_x/)の「商談予約・購入予約受付中」 |
| eKクロス EV | 3 | [商品ページ](https://www.mitsubishi-motors.co.jp/lineup/ek_x_ev/index.html)の「商談予約・購入予約受付中」 |
| デリカミニ | 12 | [商品ページ](https://www.mitsubishi-motors.co.jp/lineup/delica_mini/)の「商談予約・購入予約受付中」 |
| eKスペース | 4 | [商品ページ](https://www.mitsubishi-motors.co.jp/lineup/ek_space/)の「商談予約・購入予約受付中」 |

確認日は2026-09-12。データ正本では`availabilityCheckedAt=2026-09-12`、`availability=new_order_available`、購入予約URLを保持する。三菱公式も予約サービスは来店後の売買契約で購入確定となる旨を説明しているため、サイト上の「新車注文可」は予約導線の確認範囲に限定し、個別在庫・納期・契約成立を保証しない。
...
## 2026-09-12 Mitsubishi デリカミニ／eKスペース 16販売単位追加

三菱自動車の新型デリカミニ／eKスペースについて、現行商品ページ、グレード別価格、主要装備、マイパイロット説明、2025年9月18日発表資料を照合した。両車とも2025年10月29日発売の現行カタログに掲載されており、発売日とグレード別の税込価格を販売単位へ固定した。

デリカミニは6グレード×2WD・4WDの12単位。T／GはLDPのみのLevel 1相当4単位、T Premium／G Premium（DELIMARU Packageを含む）は全車速ACC＋LKAのMI-PILOT標準でLevel 2相当8単位。eKスペースはM／G×2WD・4WDの4単位で、現行主要装備表はLDPを全車標準とする一方、MI-PILOT（ACC・LKA）の標準装備を記載していないため、4単位ともLevel 1相当とした。旧ページに残るMI-PILOT案内は現行2025年カタログと整合しないため、eKスペースのLevel 2販売単位やオプション価格は推測で追加していない。

全16単位で運転者の常時監視・操作が必要、ハンズオフ不可。デリカミニのMI-PILOTは高速道路・自動車専用道路の同一車線支援で、ACC設定車速は約30km/h以上。価格はデリカミニ196万4,600円〜290万7,300円、eKスペース174万9,000円〜194万5,900円（税込）。注文可否は公式掲載だけでは確定できないため、全16単位をunknownとした。

| モデル | 掲載単位 | Level 1 | Level 2 | 価格（税込） |
|---|---:|---:|---:|---:|
| デリカミニ | 12 | 4（T／G） | 8（T Premium／G Premium、DELIMARU Package含む） | 1,964,600〜2,907,300円 |
...
現行カタログ掲載は`catalogAsOf=2026-07`へ、公式取扱説明書の「発売年月2026年07月～」は`salesUnitIntroducedAt=2026-07`として34単位へ反映した。Honda公式資料では個別タイプの現在の注文受付・在庫・納期を固定できないため、`priceEffectiveAt`は未設定、`availability=unknown`とした。公式商品・販売店・試乗・見積り・カタログ導線は`src/data/official-links.json`に記録し、一覧・詳細・比較の価格、能力差、発売年月、Level 2フィルターへ反映した。
